...
/**
 * <p>
 * Template for viewing method-level mutants: show original source code, source code of the selected mutants, summary of mutants </p>
 *
 * @author Yu-Seung Ma
 * @version 1.0
 */
public class TraditionalMutantsViewerPanel extends MutantsViewerPanel {
    ...
    void jbInit() throws Exception {
        ...
        /**
         * summary table: containing the numbers of mutants by each method-level mutation operators along with the total number of mutants generated
         */
        ...
        /**
         * show a list of mutants to be selected for viewing -- click on the mutant to display the original source and mutated code
         */
