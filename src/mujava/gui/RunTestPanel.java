...
import mujava.gui.utils.tablemodel.CMSummaryTableModel;
import mujava.gui.utils.tablemodel.ResultTableModel;
import mujava.gui.utils.tablemodel.TMSummaryTableModel;
import mujava.test.*;
import mujava.util.*;

/**
 * <p>
 * Panel for running mutant against a given test suite</p>
 *
 * @author Yu-Seung Ma
 * @version 1.0
 * @update Nan Li
...
public class RunTestPanel extends JPanel implements ActionListener {
    ...
    void initSummaryTable() {
        ...
        cmTable = new JTable(tmodel);
        adjustSummaryTableSize(cmTable, tmodel);
    }
    ...
    void changeTimeOut() {
        ...
        if (tstr.equals("3 seconds")) {
            ...
            if (tstr.equals("5 seconds")) {
                timeoutTextField.setEnabled(false);
                timeoutTextField.setText("5");
                isCustomizedTimeout = false;
                timeout_secs = 5000;
            } else {
                if (tstr.equals("10 seconds")) {
                    timeoutTextField.setEnabled(false);
                    timeoutTextField.setText("10");
                    isCustomizedTimeout = false;
                    timeout_secs = 10000;
                } else {
                    if (tstr.equals("Other")) {
...
// Mutants ==> (x,y) = (1,1)
    ...
    void onMouseClicked_testRunB(MouseEvent e) {
        ...
        // class name and method name whose mutants are executed
        ...
        if ((targetClassObj != null) && (testSetObject != null)) {
            ...
            try {
                if (onlyClassButton.isSelected()) {
                    ...
                    if (onlyTraditionalButton.isSelected()) {
                ...
                JOptionPane.showMessageDialog(null, "The test was executed.", "Advise", JOptionPane.INFORMATION_MESSAGE);
