...
/**
 * <p>
 * Generate traditional mutants according to selected operator(s) from
 * gui.GenMutantsMain. The original version is loaded, mutated, and compiled.
 * Outputs (mutated source and class files) are in the traditional-mutants
 * folder. </p>
 *
 * <p>
 * Currently available traditional mutation operators: (1) AORB: Arithmetic
 * Operator Replacement (Binary), (2) AORU: Arithmetic Operator Replacement
 * (Unary), (3) AORS: Arithmetic Operator Replacement (Short-cut), (4) AODU:
 * Arithmetic Operator Deletion (Unary), (5) AODS: Arithmetic Operator Deletion
 * (Short-cut), (6) AOIU: Arithmetic Operator Insertion (Unary), (7) AOIS:
 * Arithmetic Operator Insertion (Short-cut), (8) ROR: Rational Operator
 * Replacement, (9) COR: Conditional Operator Replacement, (10) COD: Conditional
 * Operator Deletion, (11) COI: Conditional Operator Insertion, (12) SOR: Shift
 * Operator Replacement, (13) LOR: Logical Operator Replacement, (14) LOI:
 * Logical Operator Insertion, (15) LOD: Logical Operator Deletion, (16) ASRS:
    ...
    void genTraditionalMutants(ClassDeclarationList cdecls) {
        ...
        for (int j = 0; j < cdecls.size(); ++j) {
            ...
            if (tempName.equals(MutationSystem.CLASS_NAME)) {
               ...
               {
                  System.out.println("  Applying SID ... ... ");
               ...
               {
                  System.out.println("  Applying SWD ... ... ");
