...
public class MutantCodeWriter extends ParseTreeVisitor {
    ...
    public void visit(CompilationUnit p)
        ...
        line_num++;
        out.println("// Author: MuJava4Run v1.1 (Adapted from MuJava)");        
        line_num++;
        out.println();
        line_num++;
    ...
    protected void writeLog(String changed_content) {
        ...
        CodeChangeLog.writeLog(obj);
         */
        CodeChangeLog.writeLog(class_name + MutationSystem.LOG_IDENTIFIER + mutated_line + MutationSystem.LOG_IDENTIFIER + changed_content);
    }
