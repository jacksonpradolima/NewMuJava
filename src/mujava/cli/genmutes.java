...
public class genmutes {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File folder = new File("C:\\Users\\Jackson Lima\\Documents\\Bitbucket\\muJava");
        ...
        // if(jct.getD())
        // {
        File sessionFolder = new File("C:\\Users\\Jackson Lima\\Documents\\Bitbucket\\muJava" + "/" + sessionName + "/src");
    ...
    private static void setJMutationStructureAndSession(String sessionName) {
        ...
        muJavaHomePath = "C:\\Users\\Jackson Lima\\Documents\\Bitbucket\\muJava" + "/" + sessionName;
    ...
    public static void generateMutants(String[] file_list, HashMap<String, List<String>> traditional_ops) throws IOException {
